Ext.define('Portal.view.FaiDfaiJobService.FaiDfaiJobGrid', {
	...
	listeners : {
		itemdblclick : function(thi, record, item, index, e, eOpts) {
			...
			if (!tabPanel.getChildByElement('faiDfaiJobUpdateForm')) {
				tabPanel.add({
				...
				Ext.ComponentQuery.query('#faiDfaiJobUpdateForm')[0]
						.loadRecord(record);
				var img = Ext.ComponentQuery.query('#faiDfaiUpdateImage')[0];
				...
				var role = Ext.ComponentQuery.query('#loginFormHiddenRole')[0]
						.getValue();
				if (role != 'Admin') {
					Ext.ComponentQuery.query('#faiDfaiProjectName2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiProjectCategory2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiPeriod2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiKhCode2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiMachineCode2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiSetupApResp2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiPartNumber2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiDrpNumber2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiFixtureStart2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiFixtureEnd2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiCatiaStart2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiCatiaEnd2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiDocumentStart2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiDocumentEnd2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiBenchStart2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiBenchEnd2')[0]
							.setReadOnly(true);
					Ext.ComponentQuery.query('#faiDfaiResponsible2')[0]
							.setReadOnly(true);
				}
				if (role == 'PM') {
